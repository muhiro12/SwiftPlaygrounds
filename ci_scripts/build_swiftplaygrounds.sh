...
project_path="SwiftPlaygrounds.xcodeproj"
scheme_name="SwiftPlaygrounds"
...
timestamp=$(date +%s)
result_bundle_path="$results_directory/BuildResults_SwiftPlaygrounds_${timestamp}.xcresult"
...
echo "Finished SwiftPlaygrounds build. Result bundle: $result_bundle_path"
